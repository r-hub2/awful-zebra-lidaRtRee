...
#' @keywords datasets
#'
#' @references Monnet, J.-M. 2021. Tutorial on modeling forest parameters with ALS data. ABA data preparation \url{https://lidar.pages-forge.inrae.fr/lidaRtRee/articles/area-based.1.data.preparation.html}
#'
#' @examples
