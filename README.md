# _lidaRtRee_ <img src="man/figures/logo.png" align="right" height="139"/>
<!-- badges: start -->
[![CRAN status](https://www.r-pkg.org/badges/version/lidaRtRee)](https://CRAN.R-project.org/package=lidaRtRee)
...
* Build development version from source with the `devtools` package: `devtools::install_git("https://forge.inrae.fr/lidar/lidaRtRee")`.

# Tutorials

Tutorials using `lidaRtRee` functions are available in the [vignettes](https://forge.inrae.fr/lidar/lidaRtRee/-/tree/main/vignettes) folder as `Rmarkdown` files, including datasets to run the code. The available tutorials are:

* [ALS data pre-processing](https://lidar.pages-forge.inrae.fr/lidaRtRee/articles/ALS_data_preprocessing.html).
* [Tree detection](https://lidar.pages-forge.inrae.fr/lidaRtRee/articles/tree.detection.html).
* [Forest field plot coregistration with ALS data](https://lidar.pages-forge.inrae.fr/lidaRtRee/articles/coregistration.html).
* [Forest gaps and edges detection](https://lidar.pages-forge.inrae.fr/lidaRtRee/articles/gaps.edges.detection.html).
* [Forest structure metrics computation and mapping](https://lidar.pages-forge.inrae.fr/lidaRtRee/articles/forest.structure.metrics.html).
* Area-based approach for forest parameters estimation:
  - [data preparation](https://lidar.pages-forge.inrae.fr/lidaRtRee/articles/area-based.1.data.preparation.html), 
  - [model calibration](https://lidar.pages-forge.inrae.fr/lidaRtRee/articles/area-based.2.model.calibration.html) and 
  - [mapping](https://lidar.pages-forge.inrae.fr/lidaRtRee/articles/area-based.3.mapping.and.inference.html).
